    ...
    <?php
        ...
        if($registro == true) {
            ...
            $options=array(
                ...
                CURLOPT_URL=>'http://localhost/dashboard/Proyecto%20Diseño/FormularioUsuario/LoginQuick/LoginCamionero/RegistrarseQuickCarry/RegistrarseCamionero/usuarioCamioneroRegistrado.php',
                CURLOPT_POST=>1,
...
if($filas>0){
    ...
    $options=array(
        ...
        CURLOPT_URL=>'http://localhost/dashboard/Proyecto%20Diseño/FormularioUsuario/LoginQuick/LoginCamionero/RegistrarseQuickCarry/RegistrarseCamionero/panelCamionero.php',
        CURLOPT_POST=>1,
        CURLOPT_POSTFIELDS=>$datos,
        CURLOPT_RETURNTRANSFER=>1
    );
