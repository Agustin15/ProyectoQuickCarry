...
<body>
    ...
    $claseAuten = new autenticacionQuick();
                ...
                if ($regUsuario > 0) {
                    ...
                    if (password_verify($contrasenia, $regUsuario['contrasenia'])) {
                        $datos = array(
                            ...
                            'numChoferCamion' => $regUsuario['numChoferCamion'],
                            'cedula' => $regUsuario['cedula'], 'correo' => $regUsuario['correo'],
                            'matriculaCamion' => $regUsuario['matriculaCamion']
                            ,'contrasenia' => $regUsuario['contrasenia']
                     ...
                     curl_setopt($ch,CURLOPT_URL,"http://$_SERVER[HTTP_HOST]/CronosLogistics/FormularioUsuario/LoginQuick/LoginCamionero/RegistrarseQuickCarry/RegistrarseCamionero/views/index.php");
