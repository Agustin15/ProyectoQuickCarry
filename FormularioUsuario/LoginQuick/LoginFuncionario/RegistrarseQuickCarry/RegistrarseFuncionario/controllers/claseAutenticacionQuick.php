...
class autenticacionCrecom
{
    ...
    public function obtenerNumFuncionarioQuick($numFuncio)
    {
        $consulta = $this->conexion->bd()->prepare("select * from funcionariosquickcarry where numFuncio=?");
    ...
    public function registrado($nombre, $apellido, $usuario, $numFuncio, $cedula, $correo, $contrasenia)
    {
        ...
        $consulta = $this->conexion->bd()->prepare("insert into funcionariosquickcarry
