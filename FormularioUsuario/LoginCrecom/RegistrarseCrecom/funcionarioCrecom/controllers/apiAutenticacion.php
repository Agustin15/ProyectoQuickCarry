...
<body>
    ...
    require('claseAutenticacionCrecom.php');
            ...
            if (empty($usuario) || empty($contrasenia)) {
                ...
                if ($regUsuario > 0) {
                    ...
                    if (password_verify($contrasenia, $regUsuario['contrasenia'])) {
                        ...
                        curl_setopt($ch,CURLOPT_URL,"http://$_SERVER[HTTP_HOST]/CronosLogistics/FormularioUsuario/LoginCrecom/RegistrarseCrecom/funcionarioCrecom/views/index.php");
