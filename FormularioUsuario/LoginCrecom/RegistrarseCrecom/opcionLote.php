...
case 'eliminar':
    ...
    $datos=array('opcion'=>'eliminar','numLote'=>$numLote);
     ...
     //le pasa un array con el numLote y la opcion a la api de almacen 
    $ch= curl_init();
                
    $options=array(
    
        CURLOPT_URL=>'http://localhost/dashboard/Proyecto%20Diseño/formularioUsuario/LoginCrecom/RegistrarseCrecom/apiAlmacen.php',
        CURLOPT_POST=>1,
...
case 'modificar':
    ...
    $camionMatricula=$_GET['camionMatricula'];
     ...
     //le pasa un array con el numLote,los datos a modificar del lote y la opcion a la api de almacen 
    ...
    $direccion=$_GET['direccion'];
     ...
     //le pasa un array con la opcion y los datos del lote que quires agregar para la api de almacen 
