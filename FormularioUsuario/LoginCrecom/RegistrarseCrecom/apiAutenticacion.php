...
case "registrarse":
        ...
        if($registro == true) {
            ...
            $datos=array(
                ...
                $options=array(
                    ...
                    CURLOPT_URL=>'http://localhost/dashboard/Proyecto%20Diseño/FormularioUsuario/LoginCrecom/RegistrarseCrecom/usuarioRegistradoCrecom.php',
                    CURLOPT_POST=>1,
    ...
    case "login":
       ...
       $options=array(
           ...
           CURLOPT_URL=>'http://localhost/dashboard/Proyecto%20Diseño/FormularioUsuario/LoginCrecom/RegistrarseCrecom/listaLotes.php',
           CURLOPT_POST=>1,
           CURLOPT_POSTFIELDS=>$datos,
           CURLOPT_RETURNTRANSFER=>1
       );
