...
<head>
    ...
    <title>Borrar usuario Quick Carry</title>
</head>
<body>
...
$sentencia = "select * from funcionariosquickcarry where id='$id'";
...
if ($reg = mysqli_fetch_array($registro)) {
    ...
    $sentencia2 =$conexion->prepare("delete from funcionariosQuickCarry where id=?");
...
?>   
    ...
    ?>
    <a class="msj">Error al eliminar el usuario</a>
