...
<head>
    ...
    <title>Modificar datos del funcionario Quick Carry</title>
</head>
...
<body>
    ...
    $seleccionId = $conexion->prepare("select * from funcionariosquickcarry where id=?");
    ...
    <br>
    <form method="POST" action="nuevosDatosUsuarioQuick.php" id="formModificar">
        <img src="img/actualizarUsuario.png" width="60px">
        <br>
        <br>
        <br>
        <h2>Actualizar Usuario Quick Carry</h2>
        ...
        <input placeholder="Correo" required="true" type="email" name="correo" value="<?php echo $reg['correo'] ?>">
        <br>
        <br>
