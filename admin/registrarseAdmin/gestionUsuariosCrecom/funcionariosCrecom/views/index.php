...
<head>
    ...
    <title>Registros funcionarios Crecom</title>
</head>
...
<body>
   ...
   <a href="agregarUsuarioCrecom.php"><button id="agregar">Agregar funcionario Crecom</button></a>
   <br><br>
    <hr>
    <?php
    ...
    if ($registros->fetch_array() != null) {
       ...
       <thead>
        ...
        foreach ($usuarios->fetch_all(MYSQLI_ASSOC) as $usuario) {
            ...
            <tbody>
            <tr>
            <td><?php echo $usuario['id']?><img src="img/usuario.png" width="20px">
            <td><?php echo $usuario['nombre']?></td>
            <td><?php echo $usuario['apellido']?></td>
            <td><div id="eliminar"><a href="borrarUsuarioCrecom.php?id=<?php echo $usuario['id']?>">Eliminar</a>
        </div><div id="modificar"><a href="modificarUsuarioCrecom.php?id=<?php echo $usuario['id']?>">Modificar</a></div>
        <div id="masInfo"><a href="datosUsuarioCrecom.php?id=<?php echo $usuario['id']?>">Mas Info</a></div>  </td>
            <tr>
            </tbody>
                <?php
        }
