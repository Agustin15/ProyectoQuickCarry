...
<body>
    ...
    if (
        ...
        $repetidoNumFuncioEnCrecom = $claseDatosUsuario->comprobarnumFuncioRepetido($numFuncio);
    ...
    ?>
            ...
            <div class="msjEliminar">
                ...
                <div>
                    ...
                    if (
                        $repetidoCedulaEnChofer > 0
                        || $repetidoCedulaEnCrecom > 0 || $repetidoCedulaEnFuncioQuick > 0
                    ) {
                    ...
                    ?>
                        ...
                        <div class="msjEliminar">
                            ...
                            <div>
                                ...
                                if (
                                    $repetidoUsuarioEnCrecom > 0 || $repetidoUsuarioEnAdmin > 0
                                    || $repetidoUsuarioEnChofer > 0 || $repetidoUsuarioEnClienteCrecom > 0
                                ...
                                ?>
                                    ...
                                    <div class="msjEliminar">
                                        ...
                                        <div>
                                            ...
                                            if ($repetidoNumFuncioEnCrecom > 0) {
                                                ...
                                                <div class="msjEliminar">
                                                    ...
                                                    <script>
                                                        function volver() {
                                                            ...
                                                            location.href = "agregarUsuarioCrecom.php";
