...
<head>
    ...
    <title>Modificar datos del cliente Crecom</title>
</head>
...
<body>
    ...
    $seleccionId = $conexion->prepare("select * from clientecrecom where idCliente=?");
    ...
    <br>
    <form method="POST" action="nuevosDatosClienteCrecom.php" id="formModificar">
        <img src="img/actualizarUsuario.png" width="60px">
        <br>
        <br>
        <br>
        <h2>Actualizar cliente Crecom</h2>
        ...
        <input placeholder="Correo" required="true"  type="email" 
        name="correo" value="<?php echo $reg['correo'] ?>">
