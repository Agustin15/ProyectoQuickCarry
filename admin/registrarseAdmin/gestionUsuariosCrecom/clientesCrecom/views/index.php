...
<head>
    ...
    <title>Registros clientes Crecom</title>
</head>
...
<body>
    ...
    <div id="containerTable">
        ...
        <a href="agregarClienteCrecom.php"><button id="agregar">Agregar cliente Crecom</button></a>
        <br><br>
        <hr>
        ...
        ?>
            <table id="tableClientes">
                ...
                ?>
                    <tbody>
                        <tr>
                            <td><?php echo $usuario['idCliente'] ?><img src="img/usuario.png" width="20px"></td>
                            <td><?php echo $usuario['nombre'] ?></td>
                            <td><?php echo $usuario['apellido'] ?></td>
                            <td>
                                <div id="eliminar"><a href="borrarClienteCrecom.php?id=<?php echo $usuario['idCliente'] ?>">Eliminar</a>
                                </div>
                                <div id="modificar"><a href="modificarClienteCrecom.php?id=<?php echo $usuario['idCliente'] ?>">Modificar</a></div>
                                <div id="masInfo"><a href="datosClienteCrecom.php?id=<?php echo $usuario['idCliente'] ?>">Mas Info</a></div>
                            </td>
                        <tr>
                    </tbody>
            ...
            ?>
                <div class="advertenciaPedidos">
                    ...
                    <br>
                    <br>
                    <h2>No hay clientes registrados aun </h2>
                    <br>
                </div>
...
<script>
    ...
    $(document).ready(function() {
        $("#buscador").keyup(function() {
            ...
            $.each($("#tableClientes tbody tr"), function() {
