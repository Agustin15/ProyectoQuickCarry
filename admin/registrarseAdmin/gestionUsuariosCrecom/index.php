...
$sentencia = "select * from funcionariosCrecom";
...
echo '<a href="agregarUsuarioCrecom.php"><button id="agregar">Agregar Cliente Crecom</button></a>';
echo '<br><br>';
echo '<hr>';
echo '<table>';
echo '<tr id="headTable">';
 ...
 foreach($registros->fetch_all(MYSQLI_ASSOC) as $reg){
        ...
        echo '<td><div id="eliminar"><a href="borrarUsuarioCrecom.php?id='.$reg['id'].'">Eliminar</a>
        </div><div id="modificar"><a href="modificarUsuarioCrecom.php?id='.$reg['id'].'">Modificar</a></div>
        <div id="masInfo"><a href="datosUsuarioCrecom.php?id='.$reg['id'].'">Mas Info</a></div>  </td>';
        echo '<tr>';
 }
