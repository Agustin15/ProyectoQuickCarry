            ...
            if($registro == true) {
                ...
                $datos=array(
                    ...
                    $options=array(
                        ...
                        CURLOPT_URL=>'http://localhost/dashboard/Proyecto%20Diseño/admin/registrarseAdmin/usuarioRegistradoAdmin.php',
                        CURLOPT_POST=>1,
    ...
    break;
        ...
        case "login":
           ...
           $options=array(
               ...
               CURLOPT_URL=>'http://localhost/dashboard/Proyecto%20Diseño/admin/registrarseAdmin/panelAdmin.php',
               CURLOPT_POST=>1,
               CURLOPT_POSTFIELDS=>$datos,
               CURLOPT_RETURNTRANSFER=>1
           );
